...
const translations: Translations = {
  ...
  "family.myChildren": { en: "My Family", ka: "ჩემი ოჯახი" },
  ...
  "family.addMember": { en: "Add Member", ka: "წევრის დამატება" },
  "family.addChild": { en: "Add a Child", ka: "შვილის დამატება" },
  "family.memberNamePlaceholder": { en: "Name...", ka: "სახელი..." },
  "family.childNamePlaceholder": { en: "Child's name...", ka: "შვილის სახელი..." },
  "family.selectType": { en: "Select relationship", ka: "აირჩიე ტიპი" },
  "family.type.child": { en: "Child", ka: "შვილი" },
  "family.type.partner": { en: "Spouse / Partner", ka: "პარტნიორი" },
  "family.type.father": { en: "Father", ka: "მამა" },
  "family.type.mother": { en: "Mother", ka: "დედა" },
  "family.type.brother": { en: "Brother", ka: "ძმა" },
  "family.type.sister": { en: "Sister", ka: "და" },
  "family.type.grandfather": { en: "Grandfather", ka: "პაპა" },
  ...
  "regenerate.timeout": { en: "Generation took too long. Please try again.", ka: "გენერაცია ვერ მოხერხდა. სცადე ხელახლა." },
  ...
  // Onboarding
  "onboarding.title": { en: "Tell Us About You", ka: "მოგვიყევი შენს შესახებ" },
  "onboarding.subtitle": { en: "So the stars can guide you ✨", ka: "რომ ვარსკვლავებმა გიმძღვანელონ ✨" },
  ...
  "dashboard.readingStars": { en: "Loading...", ka: "იტვირთება..." },
